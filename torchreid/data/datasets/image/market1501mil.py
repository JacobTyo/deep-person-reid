...
class Market1501Mil(ImageDataset):
    """Market1501Mil.

    The standard Market1501 dataset, but transformed into a MIL problem.
        ...
        for img_path in img_paths:
            ...
            if add_mil_noise:
                ...
                for i in range(3):
                    ...
                    while new_pid == pid:
                        if relabel:
                            new_pid = random.choice(list(pid2label.values()))
                        else:
                            new_pid = random.choice(list(pid_container))
